...
extern void halLcdSetBackLight(unsigned char BackLightLevel); // BackLightLevel = 0 - 16
...
extern void halLcdSetContrast(unsigned char ContrastLevel); // ContrastLevel = 70 - 127
